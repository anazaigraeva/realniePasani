...
import axiosInstance from '../../axiosinstance';
 ...
 const [likes, setLikes] = useState(null);
    ...
    const addHandler = () => axiosInstance.post(`/likes`, {userId: userId, wordId:wordId}).then((response) =>{
  ...
  return (
    <>
    <button className='likeButton' onClick={() => addHandler().then(() => setActive((status) => !status))}>{active ? '♥' : '♡'}</button>
